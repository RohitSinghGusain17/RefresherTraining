...
public static class FinancialCalculator
{
    ...
    public static double CalculateCompoundInterest(double principal, double rate, int time, int compoundingFrequency = 1)
    {
...
public class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine($"Future Value = {amount1:F2}");
        Console.WriteLine($"Future Value = {amount2:F2}");
    }
}